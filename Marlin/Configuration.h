...
#define STRING_CONFIG_H_AUTHOR "(German_1984, Flsun i3 custom)" // Who made the changes.
...
#define PIDTEMPBED
  ...
  #define DEFAULT_bedKp 59.21
  #define DEFAULT_bedKi 11.66
  #define DEFAULT_bedKd 200.50
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 100, 100, 400, 408 }
